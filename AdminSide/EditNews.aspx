<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNews.aspx.cs" Inherits="AdminSide_EditNews" %>
            ...
            <div class="container" >
                    ...
                    <div >
                           <asp:label ID="lblCountryName" class="" runat="server" text="Country">Country:-</asp:label><br />
                             ...
                             <asp:label ID="lblDate" class="" runat="server" text="News Date">News Date:-</asp:label><br />
                             <asp:TextBox ID="TxtDate" ReadOnly  placeholder="Enter Country Name" class="form-control" runat="server" Required></asp:TextBox><br />
