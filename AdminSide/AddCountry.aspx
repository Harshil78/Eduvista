<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCountry.aspx.cs" Inherits="AdminSide_AddCountry" %>
...
<div>
     ...
     <div class="modal-header">
            <h4 class="modal-tittle">Add Country</h4>
            ...
            <div class="container" >
                    ...
                    <div >
                       ...
                       <asp:label ID="LblImage" class="" runat="server" text="Image">Image:-</asp:label><br />
                        ...
                        class="form-control btn btn-success  "   runat="server" Text="Add" 
